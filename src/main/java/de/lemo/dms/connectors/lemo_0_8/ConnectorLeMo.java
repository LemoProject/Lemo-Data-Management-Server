 ...
 */
public class ConnectorLeMo extends AbstractConnector {

	private DBConfigObject config;

	public ConnectorLeMo(final DBConfigObject config) {
		this.config = config;
	}
	...
	@Override
	public void getData() {
		final ExtractAndMapLeMo extract = new ExtractAndMapLeMo(this);
