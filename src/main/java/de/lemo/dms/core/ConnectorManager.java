...
public class ConnectorManager {
    ...
    private ConnectorManager() {
        ...
        connectors.put(ESourcePlatform.Moodle_1_9_Numeric,
            new de.lemo.dms.connectors.moodleNumericId.ConnectorMoodle());
        ...
        connectors.get(ESourcePlatform.Moodle_1_9).setSourceDBConfig(
            ServerConfigurationHardCoded.getInstance().getSourceDBConfig());
    }
    ...
    public boolean updateData(long fromTimestamp) {
        ...
        selectedConnector.updateData("Moodle_1_9", fromTimestamp); // XXX
        return true;
    }
