				 ...
				 for(int i = 0 ; i < ilm.size(); i++)
					 if(ilm.get(i).getForum() != null)
						 if(rri.get(ilm.get(i).getForum().getId()) == null)
							 rri.put(ilm.get(i).getForum().getId(), new ResourceRequestInfo(ilm.get(i).getForum().getId(), EResourceType.FORUM, 1L, ilm.get(i).getForum().getTitle(), 0L));
						 else
				 ...
				 for(int i = 0 ; i < ilm.size(); i++)
					 if(ilm.get(i).getQuestion() != null)
						 if(rri.get(ilm.get(i).getQuestion().getId()) == null )
							 rri.put(ilm.get(i).getQuestion().getId(), new ResourceRequestInfo(ilm.get(i).getQuestion().getId(), EResourceType.QUESTION, 1L, ilm.get(i).getQuestion().getTitle(), 0L));
						 else
				 ...
				 for(int i = 0 ; i < ilm.size(); i++)
					 if(ilm.get(i).getQuiz() != null)
						 if(rri.get(ilm.get(i).getQuiz().getId()) == null)
							 rri.put(ilm.get(i).getQuiz().getId(), new ResourceRequestInfo(ilm.get(i).getQuiz().getId(), EResourceType.QUIZ, 1L, ilm.get(i).getQuiz().getTitle(), 0L));
						 else
				 ...
				 for(int i = 0 ; i < ilm.size(); i++)
					 if(ilm.get(i).getResource() != null)
						 if(rri.get(ilm.get(i).getResource().getId()) == null)
							 rri.put(ilm.get(i).getResource().getId(), new ResourceRequestInfo(ilm.get(i).getResource().getId(), EResourceType.RESOURCE, 1L, ilm.get(i).getResource().getTitle(), 0L));
						 else
				 ...
				 for(int i = 0 ; i < ilm.size(); i++)
					 if(ilm.get(i).getWiki() != null)
						 if(rri.get(ilm.get(i).getWiki().getId()) == null)
							 rri.put(ilm.get(i).getWiki().getId(), new ResourceRequestInfo(ilm.get(i).getWiki().getId(), EResourceType.WIKI, 1L, ilm.get(i).getWiki().getTitle(), 0L));
						 else
